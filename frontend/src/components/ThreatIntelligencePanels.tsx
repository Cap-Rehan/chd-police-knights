...
export const ThreatIntelligencePanels: React.FC<ThreatIntelligencePanelsProps> = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-5">
      ...
      <div className="bg-[#0c0c0c] border border-zinc-800 rounded-lg p-3.5 flex flex-col justify-between shadow-xs">
        <div>
          ...
          {/* Anomaly Callout Tag */}
          <div className="mt-2.5 mb-2 px-2 py-1 rounded bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-mono flex items-center justify-between">
            <span>▲ +214% spike — 'fentanyl analogues' (Punjab/CHD region)</span>
          </div>
      ...
      {/* PANEL B: THREAT CLASSIFICATION RATIO (Replaced with Donut Pie Chart) */}
      <div className="bg-[#0c0c0c] border border-zinc-800 rounded-lg p-3.5 flex flex-col justify-between shadow-xs">
        <div>
          <div className="flex items-center justify-between pb-2 border-b border-zinc-800">
            <div className="flex items-center gap-2">
          ...
          {/* Pie Chart & Metrics Legend */}
          <div className="flex items-center justify-between h-36 pt-1">
            ...
            {/* Legend Breakdown */}
            <div className="w-[55%] space-y-1.5 pl-2 font-mono text-xs">
          ...
          <div className="my-2 space-y-2">
            ...
            <div className="p-2 rounded bg-black border border-zinc-800 text-xs font-mono flex items-start gap-2">
              ...
              <div className="space-y-0.5">
                <div className="text-zinc-200">STIX bundle--9e4c8f… dispatched to LEA command center</div>
                <div className="text-[10px] text-zinc-500">10:55:20 UTC • High Priority (PunjabSynthetics_01)</div>
              </div>
            </div>
            ...
            <div className="p-2 rounded bg-black border border-zinc-800 text-xs font-mono flex items-start gap-2">
              <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400 shrink-0 mt-0.5" />
              <div className="space-y-0.5">
                <div className="text-zinc-200">STIX bundle--3a11b8… dispatched to Narcotics Control</div>
                <div className="text-[10px] text-zinc-500">10:48:38 UTC • Sector 17 Dead Drop Match</div>
              </div>
            </div>
            ...
            <div className="p-2 rounded bg-amber-500/5 border border-amber-500/20 text-xs font-mono flex items-start gap-2">
              ...
              <div className="space-y-0.5">
                <div className="text-amber-400">PENDING REVIEW — confidence below 0.85 gate</div>
                <div className="text-[10px] text-zinc-500">CryptoElonBot (Giveaway Lure) • Queued for Analyst</div>
              </div>
            </div>
          </div>
        </div>
